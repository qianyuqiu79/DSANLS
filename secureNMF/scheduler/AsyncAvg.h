#ifndef NMF_ASYNCAVG_NODUMP_H
#define NMF_ASYNCAVG_NODUMP_H
...
class AsyncAvg : public SchedulerAbstract {

public:
    AsyncAvg(const Parameter &parameter) : SchedulerAbstract(parameter, noprapere_tag()) {
        MPI_Init(NULL, NULL);
                ...
                do {
                    ...
                    if (probed) {
                        ...
                        U_global = U_global * (1.0-omega) +
                                   omega * recv_buffer;
//                        U_global = U_global * ((update_round - 1.0)/ update_round) +
//                                   (1.0 / update_round) * recv_buffer;
